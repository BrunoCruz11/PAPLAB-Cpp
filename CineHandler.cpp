...
void CineHandler::agregarFuncionEnCine(DtPelicula p, DtCine c, DtSala s, DtHorario horarioNuevo,DtFecha fechaNueva){ // agregue Dt fecha en parametros (antes no estaba), y le cambie el nombre de los cabezales asi es mas entendible
